...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('send').onclick = async function (e) {
        ...
        // (async () => {
        //     const type = await fileTypeFromFile(fileInput.files[0]);
    ...
    function displayAllChatMsgs(data) {
        ...
        const multimediaType = data.multimediaType; // Assuming multimediaType can be 'image' or 'video'
        ...
        if (senderId == userId) {
            ...
            if (message) {
                ...
                messageContainer.id = receiverId; // Use receiverId for the receiver
            ...
            if (multimedia) {
                ...
                multimediaContainer.id = receiverId; // Use receiverId for the receiver
